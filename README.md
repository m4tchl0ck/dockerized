...
| [dev-full-remote](dev-full-remote/README.md) | Hardened build of dev-full for a container reachable from the internet. Activates the cloud sshd profile shipped by dev-base, drops the passwordless sudo grant, and runs sessions as an unprivileged account. |
